...
namespace Siemens.UAClientHelper
{
    public class UAClientHelperAPI
    {
        ...
        public void __AsyncWriteValue(List<string> nodeidstr, List<object> values, AsyncCallback callBack)
        {
        ...
        /// <exception cref="Exception">Throws and forwards any exception with short error description.</exception>
        public void AsyncWriteValue(List<String> nodeIdStrings, List<String> values , AsyncCallback callBack)
        {
            ...
            try
            {
                ...
                mSession.BeginWrite(null, valuesToWrite, callBack, valuesToWrite);
