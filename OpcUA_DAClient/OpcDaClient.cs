    ...
    public class OpcDaClient : OpcClient
    {
       ...
       /// <summary>
        ...
        public bool Disconnect()
        {
            ...
            IsConnected = _DaClient.DisConnect();
       ...
       /// <returns></returns>
        ...
        {
            return AsyncWrite(new List<TagItem>(){tag});
        }
       ...
       /// <returns></returns>
        ...
        {
            if (bl == null) throw new ArgumentNullException();
        ...
        /// </summary>
        /// <param name="bl"></param>
        private void GetServerUserTag(BLModal bl)
        {
            if (bl == null) throw new ArgumentNullException();
            if (bl.ItemType == ItemType.Tag)
            {
